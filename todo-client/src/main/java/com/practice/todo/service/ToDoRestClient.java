...
import com.practice.todo.error.ToDoErrorHandler;
import com.practice.todo.property.ToDoRestClientProperties;
...
public class ToDoRestClient {
    ...
    public ToDo findById(String id){
        ...
        return restTemplate.getForObject(
                properties.getUrl()+properties.getBasePath()+"/{id}",
                ToDo.class,
                params);
    }
    ...
    public ToDo setCompleted(String id) throws URISyntaxException {
        ...
        restTemplate.getForObject(
                properties.getUrl() + properties.getBasePath() + "/{id}?_method=patch",
